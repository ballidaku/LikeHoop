...
public class RoundedCornersImageView extends ImageView
{
    ...
    public
    RoundedCornersImageView(Context context)
    {
        super(context);
    ...
    public
    RoundedCornersImageView(Context context, AttributeSet attrs)
    {
        super(context, attrs);
    ...
    public
    RoundedCornersImageView(Context context, AttributeSet attrs, int defStyle)
    {
...
/*    public void setImageUrl(Context con, String URL)
    {
        ...
        options = new DisplayImageOptions.Builder().cacheInMemory(true).cacheOnDisc(true).resetViewBeforeLoading(true).showImageForEmptyUri(R.mipmap.no_media).showImageOnFail(R.mipmap.no_media).showImageOnLoading(R.mipmap.loading_image).build();
